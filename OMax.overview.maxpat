...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2.0, 577.0, 947.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1334.0, -45.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1376.0, -44.0, 87.0, 22.0 ],
					"text" : "loadmess path"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1424.0, 59.0, 177.0, 22.0 ],
					"text" : "s OMax_overview_patchpath"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 984.0, 17.0, 459.0, 22.0 ],
					"text" : "\"Macintosh_HD:/Users/gabloch/Documents/Max 9/Packages/OMax-5.5/\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1376.0, -12.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 387.0, 540.0, 269.0, 35.0 ],
					"text" : ";\rmax launchbrowser http://repmus.ircam.fr/omax5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 387.0, 496.0, 231.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 502.0, 106.5, 231.0, 19.0 ],
					"text" : "http://repmus.ircam.fr/omax5",
...
, 			{
				"box" : 				{
					...
					"text" : "Get more info, context, demos and medias at the OMax5 project page:",
...
, 			{
				"box" : 				{
					...
					"text" : "Max application and library for live interaction with musicians in improvisation, composition or installation scenarios. \nDeveloped by the Music Representation team at IRCAM.",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1109.0, 223.0, 54.0, 22.0 ],
					"text" : "onecopy"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1126.0, 512.0, 101.0, 20.0 ],
									"text" : "3-Templates"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 77.75, 151.0, 165.0, 22.0 ],
													"text" : "1-OMax.OBb_START.maxpat"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 127.0, 158.0, 22.0 ],
													"text" : "1-OMax.OB_START.maxpat"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 187.0, 194.0, 166.0, 22.0 ],
													"text" : "3-OMax.Visu-Window.maxpat"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 134.5, 170.0, 201.0, 22.0 ],
													"text" : "2-OMax.PolyImproOB_4o.st.maxpat"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 21.0, 93.0, 246.0, 22.0 ],
													"text" : "sel 1 2 3 4"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 21.0, 63.0, 29.5, 22.0 ],
													"text" : "+ 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 231.0, 100.0, 22.0 ],
													"text" : "tosymbol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 290.0, 53.0, 22.0 ],
													"text" : "pcontrol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 263.0, 117.0, 22.0 ],
...
,
									"patching_rect" : [ 656.0, 573.0, 125.0, 22.0 ],
									"text" : "p load_Mlti_templates"
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 124.0, 100.0, 22.0 ],
													"text" : "tosymbol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 93.0, 153.0, 22.0 ],
													"text" : "sprintf Template%d.maxpat"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 215.0, 53.0, 22.0 ],
													"text" : "pcontrol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 156.0, 117.0, 22.0 ],
													"text" : "prepend loadunique"
												}
...
,
									"patching_rect" : [ 325.5, 573.0, 100.0, 22.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 93.0, 173.0, 22.0 ],
													"text" : "sprintf Template%d_bp.maxpat"
												}
...
,
									"patching_rect" : [ 6.0, 573.0, 120.0, 22.0 ],
									"text" : "p load_bp_templates"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 656.0, 120.0, 275.0, 195.0 ],
									"text" : "To use several Oracle_Bundles on different types of music, you need Bundles with different NAMES (for instance, OB and OBb)\nBang in the order:\n1- opens OMax_Bundle\n1b- opens OMax_Bundle B\n2, 3- open OMax_Player and Visualisation\nDon't forget to SAVE AS… ALL you modules in your own Project Folder.\nThe Menu on Visu and on each Player allows to chose which Bundle is playing and which is seen. The regions are Bundle independant (there are 6 regions for each Bundle).",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 331.0, 120.0, 276.0, 166.0 ],
									"text" : "Here the three main modules of OMax are loaded as separates entites in three steps:\n1- OMax_Bundle\n2- OMax_Player\n3- OMax_Visualisation\nDon't forget to SAVE AS:\n    a- The three modules (in your project folder under a new name, like My_OB, My_Player, My_Visu)\n    b- the modified main program (calling the three save-as… modules)",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 12.0, 120.0, 279.0, 79.0 ],
									"text" : "These Templates load the three main modules of OMax in one module containing bpatcher. It forces to load the playersl later.\nDon't forget to SAVE AS… your template in your own Project Folder.",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"fontsize" : 13.0,
									"htabcolor" : [ 0.000065747648478, 0.001801013946533, 0.998228549957275, 1.0 ],
									"id" : "obj-13",
									"maxclass" : "tab",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 325.5, 292.0, 287.0, 231.0 ],
									"tabs" : [ "Template 1: Pitch-MFCC-Chroma Multi Players", "Template 2 :Simplified Single Player [=Tut1]", "Template 3: Prosody Added", "Template 4: Three Prosody Added", "Template 5: Two-Pitch & Two-Prosody [=Tut2]" ],
									"textcolor" : [ 0.870588235294118, 0.862745098039216, 0.862745098039216, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 328.0, 88.0, 281.0, 24.0 ],
									"text" : "Templates with different modules",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 680.0, 89.0, 226.0, 22.0 ],
									"text" : "Multi-Bundle example",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 36.0, 89.0, 228.0, 22.0 ],
									"text" : "A-1 Templates with bpatchers",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"fontsize" : 13.0,
									"htabcolor" : [ 0.462745098039216, 0.027450980392157, 0.090196078431373, 1.0 ],
									"id" : "obj-3",
									"maxclass" : "tab",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 656.0, 322.0, 273.0, 201.0 ],
									"tabs" : [ "1-Oracle_BundleOB", "1b-Oracle_BundleOBb", "2-OMaxPlayer", "3-Visualisation" ],
									"textcolor" : [ 0.870588235294118, 0.862745098039216, 0.862745098039216, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 8.0, 2.0, 781.0, 22.0 ],
									"text" : "These patches will provide you Templates and Multi-Bundle strategie for OMax5.5",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 8.0, 31.0, 921.0, 53.0 ],
									"text" : "Use the template patches as the starting point for your performances, and go through the ready-to-use performance strategies recipes to learn more about how to achieve specific behaviours. Don't forget to SAVE AS… your template in your own Project Folder. In any case, use copies…\nFor advanced use, we strongly recommand your using different modules. Open in order 1-OMax Bundle, 2-OMax_Players, and 3_Viisualisation. ",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 6.0, 250.0, 286.0, 273.0 ],
									"spacing_x" : 12.0,
									"spacing_y" : 12.0,
									"tabs" : [ "Template 1: Pitch-MFCC-Chroma Multi Players", "Template 2 :Simplified Single Player [=Tut1]", "Template 3: Prosody Added", "Template 4: Three Prosody Added", "Template 5: Two-Pitch & Two-Prosody [=Tut2]" ],
									"textcolor" : [ 0.870588235294118, 0.862745098039216, 0.862745098039216, 1.0 ]
...
, 							{
						...
						"editing_bgcolor" : [ 0.870588235294118, 0.862745098039216, 0.862745098039216, 1.0 ]
					}
,
					"patching_rect" : [ 248.5, 391.5, 87.0, 77.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 167.0, 1201.0, 536.0 ],
					"varname" : "templates",
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 754.0, 353.0, 78.0, 22.0 ],
									"text" : "print Tutorial:"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 435.0, 266.0, 291.0, 35.0 ],
									"text" : ";\rmax launchbrowser https://www.youtube.com/watch?"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 951.0, 649.0, 150.0, 20.0 ],
									"text" : "1QuickStart"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 472.0, 523.0, 291.0, 35.0 ],
									"text" : ";\rmax launchbrowser https://www.youtube.com/watch?"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 299.0, 443.0, 114.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 440.0, 319.0, 114.0, 22.0 ],
									"text" : "to_be added shortly"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 293.0, 241.0, 114.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 308.0, 409.0, 545.0, 38.0 ],
									"text" : "In the second tutorial you will learn how to add oracles and prosodic descriptions your audio material, since this cannot be done in real time yet, and to interact with it",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 308.0, 207.0, 545.0, 38.0 ],
									"text" : "The first tutorial will give you an overview of the OMax5 application workflow, guiding you through immediate audio capture of an oracle and how to play with it.",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"htabcolor" : [ 0.196078431372549, 0.52156862745098, 1.0, 1.0 ],
									"id" : "obj-3",
									"maxclass" : "tab",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 29.0, 389.0, 268.0, 78.0 ],
									"tabs" : [ "2 - Oracles Added & Prosax" ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 6.0, 8.0, 688.0, 25.0 ],
									"text" : "These tutorials will guide you through the usage of the OMax5.5 application.",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 6.0, 47.0, 866.0, 96.0 ],
									"text" : "Several template implementations of OMax5.5 are given, providing modular objects for immediate musical interaction.\nOMax5 uses basically 3 sub-applications: one for the Oracle Bundle, One the second one playing and the third dealing with the visualization of the oracles and playing regions. The tutorial apps contain these three modules into subpatchers.\nAfter completing these tutorials, we recommend moving to the \"Module Tutorials\" tab to explore the potentialities of OMax5.5 as a Max library, and to the \"Templates & Strategies\" tab for ready-to-use programs defining specific behaviors.",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 29.0, 187.0, 268.0, 78.0 ],
									"tabs" : [ "1 - QuickStart OMax5.5" ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 215.0, 220.0, 171.0, 22.0 ],
													"text" : "s dispose_app2_AddedProsax"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "bang" ],
													"parameter_enable" : 0,
													"patching_rect" : [ 436.0, 38.0, 24.0, 24.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 281.0, 188.0, 153.0, 22.0 ],
													"text" : "s dispose_app1_Quickstart"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 252.0, 65.0, 48.0, 22.0 ],
													"text" : "t b b"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 252.0, 100.0, 227.0, 22.0 ],
													"text" : "app2 - Oracles Added & Prosax.maxpat"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "bang", "bang" ],
													"patching_rect" : [ 21.0, 65.0, 213.0, 22.0 ],
													"text" : "t b b"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 100.0, 201.0, 22.0 ],
													"text" : "app1 - QuickStart OMax5.5.maxpat"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 188.0, 100.0, 22.0 ],
													"text" : "tosymbol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 303.0, 53.0, 22.0 ],
													"text" : "pcontrol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 220.0, 117.0, 22.0 ],
													"text" : "prepend loadunique"
												}
...
, 											{
												"patchline" : 												{
													"destination" : [ "obj-2", 0 ],
													"midpoints" : [ 261.5, 132.0078125, 30.5, 132.0078125 ],
													"source" : [ "obj-11", 0 ]
												}
...
,
									"patching_rect" : [ 9.0, 479.0, 164.0, 22.0 ],
									"text" : "p load_app_"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"hidden" : 1,
									"midpoints" : [ 163.0, 287.57421875, 18.5, 287.57421875 ],
									"source" : [ "obj-37", 1 ]
								}
...
, 							{
						...
						"originid" : "pat-18",
						"bgcolor" : [ 0.654901960784314, 0.776470588235294, 0.772549019607843, 1.0 ],
						"stripecolor" : [ 0.474509803921569, 0.470588235294118, 0.470588235294118, 1.0 ],
						"editing_bgcolor" : [ 0.870588235294118, 0.862745098039216, 0.862745098039216, 1.0 ]
					}
,
					"patching_rect" : [ 19.011363636363626, 391.5, 87.0, 77.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 167.0, 1035.0, 685.0 ],
					"varname" : "app",
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1281.0, 383.0, 62.0, 20.0 ],
									"text" : "5-Credits"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 202.0, 544.0, 276.0, 49.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 202.0, 417.0, 190.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 202.0, 481.0, 278.0, 49.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 202.0, 401.0, 190.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 10.0, 67.0, 900.0, 370.0 ],
									"text" : "Omax5 is an application and a library for live co-creative interaction with musicians in improvisation, composition or installation contexts. \nIt is based on a machine learning and generative model that provide stylistically coherent improvisation with the incoming and already learnt external audio or midi musical contents. \nIt uses a cognitive memory model based on the factor oracle. Several oracles can be built, based on diverse descriptors (pitch, mfcc, chroma, prosodic features) it analyses and learns. This learning process happens on the fly.\nImmediately, the machine is able to navigates through the recorded soundfile using concatenative synthesis according to the detected similarities, and is able to render a resulting \"improvisation\".\n\nOMax5 allows you to use up to 8 different oracles representations of the same sound, with pitch, mfcc, chroma and prosodic features. You can get coexisting different representations of the same type. For instance, you can have mfcc with 14 filter bands and with 20 bands, pitch with more or less precise detections in case of noisy signal or speech. Or one can get different prosodic features, based of fundamental frequency, with 4 or 3-letters descriptors. Some examples are given in this tutorial.\n\nOMax5 is developed by the Music Representation team at IRCAM - STMS and is part of ANR project MERCI (Mixed Musical Reality with Creative Instruments) and ERC REACH (Raising Co-creativity in Cyber-Human Musicianship) project of the European Research Council lead by Gérard Assayag).\nOMax5 development: Benjamin Levy.\nOMax5.5 features: Georges Bloch, Mikhail Malt\nTutorials and help: Georges Bloch\nOMax was originally created by Gérard Assayag, Marc Chemillier and Georges Bloch. Versions 4 and 5 developed by Benjamin Levy.\nThanks to Marco Fiorini, Mikhaïl Malt for their continuous expertise.\n\nThanks to Fabrizio Cassol, Jaap Blonk, Hervé Sellin, Joëlle Léandre and Philippe Leclerc for their musical material used in OMax5 distribution corpus.\n\nERC REACH Instagram page: \nERC REACH Youtube channel: "
								}
...
, 							{
						...
						"originid" : "pat-23",
						"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
						"bgcolor" : [ 0.870588235294118, 0.862745098039216, 0.862745098039216, 1.0 ],
						"editing_bgcolor" : [ 0.870588235294118, 0.862745098039216, 0.862745098039216, 1.0 ]
					}
,
					"patching_rect" : [ 545.0, 392.0, 95.0, 76.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 167.0, 1342.0, 407.0 ],
					"varname" : "credits",
					"viewvisibility" : 1
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1061.0, 602.0, 121.0, 20.0 ],
									"text" : "2-module"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 306.0, 149.0, 636.0, 60.0 ],
									"text" : "a- Recording of a soundfile\nb- Construction of a factor oracle based memory model, built with pitch, MFCC and Chromas descriptors, that can be aquired on the fly\", as a performer is playing.\nc- Other oracle-based memory models based can be added on prosodic analysis.",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 258.0, 410.0, 684.0, 53.0 ],
									"text" : "A view of the files of a bundle, and some tips. \nWe'll also consider how to use presets\nTO BE DONE",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 258.0, 316.0, 684.0, 38.0 ],
									"text" : "Visualisation player\nTO BE DONE",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 258.0, 221.0, 684.0, 38.0 ],
									"text" : "OMaxPlayer\nTO BE DONE",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 258.0, 125.0, 684.0, 22.0 ],
									"text" : "OMax_Bundle is the main module of OMax. Bundles, that is Memory Models, are constructed, consisting of:",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 157.0, 582.0, 40.0, 22.0 ],
									"text" : "itoa"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 121.0, 540.0, 55.0, 22.0 ],
									"text" : "zl.slice 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "list" ],
									"patching_rect" : [ 121.0, 511.0, 40.0, 22.0 ],
									"text" : "atoi"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 7.5, 16.0, 683.0, 25.0 ],
									"text" : "These tutorials will guide you through the usage of the OMax 5.5 Modules",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 8.0, 45.0, 934.0, 60.0 ],
									"text" : "With these modules, implemented to provide you a complete Max-style workflow, you could achieve the same results as the encapsulated bpatcher objects but, thanks to their modular architecture, you could build custom patches and unlock unimagined new behaviours of interaction.",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"fontname" : "Arial",
									"fontsize" : 16.0,
									"htabcolor" : [ 0.525490196078431, 0.76078431372549, 0.403921568627451, 1.0 ],
									"id" : "obj-37",
									"maxclass" : "tab",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 13.0, 125.0, 235.0, 377.0 ],
									"tabs" : [ "1. OMax_Bundle", "2. OMaxPlayer", "3. Vizu", "4. Oracle_Files" ]
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 21.0, 61.0, 29.5, 22.0 ],
													"text" : "+ 1"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 173.0, 197.0, 142.0, 35.0 ],
													"text" : "loadunique \"appmod1 - OMax_Bundle.maxpat\""
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 138.0, 100.0, 22.0 ],
													"text" : "tosymbol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 107.0, 175.0, 22.0 ],
													"text" : "sprintf appmod%d - %s.maxpat"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 214.0, 53.0, 22.0 ],
													"text" : "pcontrol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 21.0, 170.0, 117.0, 22.0 ],
													"text" : "prepend loadunique"
												}
...
,
									"patching_rect" : [ 13.0, 622.0, 163.0, 22.0 ],
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 167.0, 1129.0, 628.0 ],
					"varname" : "tutorials",
					"viewvisibility" : 1
				}
...
,
						"classnamespace" : "box",
						"rect" : [ 139.0, -1037.0, 1103.0, 611.0 ],
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 656.0, 283.0, 276.0, 136.0 ],
									"text" : "Click here to have access to some examples of Max commands controlling the parameters of the OMax5.5 objects. \nThese little command work when a OMax Setup is opened. You can copy them in your own programs."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1211.0, 423.0, 61.0, 24.0 ],
									"text" : "4-Help",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 656.0, 169.0, 275.0, 82.0 ],
									"text" : "Click here to have access to the list of Max messages available to control the parameters of the OMax5.5 objects"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 455.0, 84.0, 178.0, 21.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int", "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 443.0, 106.0, 211.0, 316.0 ],
									"tabs" : [ "OMax_parameter_docs.txt", "OMax_parameter_docs.maxpat" ]
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 248.0, 131.0, 35.0 ],
...
,
									"patching_rect" : [ 539.0, 474.0, 186.0, 26.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 6.0, 42.0, 818.0, 24.0 ],
									"text" : "In Development",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"text" : "Welcome to the Help Center of OMax5.5",
									"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
								}
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.0, 167.0, 1271.0, 451.0 ],
					"varname" : "help",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 288.0, 109.0, 22.0 ],
					"text" : "script $1 templates"
				}
...
, 			{
				"box" : 				{
					...
					"tabs" : [ "Quick Start", "Module Tutorials", "Templates & Strategies", "Help Center", "Credits" ]
				}
