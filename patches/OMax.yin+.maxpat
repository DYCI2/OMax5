...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 323.0, 150.0, 95.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.0, 180.0, 142.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 323.0, 222.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.0, 39.0, 79.0, 20.0 ],
					"text" : "loadmess 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 69.0, 105.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.0, 36.0, 91.0, 20.0 ],
					"text" : "loadmess set 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.0, 271.0, 79.0, 20.0 ],
					"text" : "loadmess 55"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 443.0, 321.0, 89.0, 20.0 ],
					"text" : "loadmess 0.56"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 297.0, 82.0, 20.0 ],
					"text" : "loadmess 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 695.0, 137.0, 55.0, 20.0 ],
					"text" : "pattrhub"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 521.0, 106.0, 59.5, 20.0 ],
					"restore" : 					{
						"Level" : [ 50 ],
						"Pitch" : [ 1 ],
						"Proba" : [ 0.56 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 323.0, 122.0, 63.0, 20.0 ],
					"text" : "pak 1 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 367.0, 95.0, 41.0, 20.0 ],
					"varname" : "YinFreq"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 323.0, 69.0, 26.00034, 20.0 ],
					"varname" : "YinSampl"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "int", "" ],
					"patching_rect" : [ 178.0, 431.0, 223.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 193.0, 194.0, 75.0, 18.0 ],
					"presentation" : 1,
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/blevy/Projets/OMax/git2svn/patches",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
