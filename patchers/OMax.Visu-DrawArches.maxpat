...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 559.0, 205.0, 74.0, 20.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 557.0, 140.0, 78.0, 20.0 ],
					"text" : "oracle name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 559.0, 169.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 419.0, 438.0, 74.0, 47.0 ],
					"text" : "bottom/top -1/1\ndefault : top"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 117.0, 344.0, 88.0, 20.0 ],
					"text" : "OMax.state2id"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 103.0, 262.0, 88.0, 20.0 ],
					"text" : "OMax.state2id"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 247.0, 343.0, 88.0, 20.0 ],
					"text" : "OMax.state2id"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 121.0, 699.0, 352.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 121.0, 529.0, 119.0, 20.0 ],
					"text" : "OMax.Visu-DrawArc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 233.0, 262.0, 88.0, 20.0 ],
					"text" : "OMax.state2id"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 409.5, 443.0, 247.0, 443.0, 247.0, 524.0, 230.5, 524.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/BenCello/Projects/OMax/Miettes OMax5",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
