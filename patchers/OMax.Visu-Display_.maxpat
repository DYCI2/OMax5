...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 328.0, 48.0, 400.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 512.0, 652.0, 89.0, 22.0 ],
					"text" : "s #1-MouseY"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.0, 318.0, 85.0, 22.0 ],
					"text" : "r #1-LastDur"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.0, 252.0, 91.0, 22.0 ],
					"text" : "r #1-LastDate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 489.0, 626.0, 106.0, 22.0 ],
					"text" : "s #1-MouseDate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 510.0, 735.0, 74.0, 22.0 ],
					"text" : "s #1-zoom"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 213.0, 115.0, 22.0 ],
					"text" : "s #1-ManualZoom"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 173.0, 113.0, 127.0, 22.0 ],
					"text" : "rect 40 850 1725 1110"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 266.0, 344.0, 104.0, 22.0 ],
					"text" : "r #1-SetCamera"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 279.0, 374.0, 88.0, 22.0 ],
					"text" : "s #1-Camera"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 366.0, 232.0, 68.0, 22.0 ],
					"text" : "s #1-hold"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 397.0, 256.0, 68.0, 22.0 ],
					"text" : "s #1-click"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 428.0, 280.0, 75.0, 22.0 ],
					"text" : "s #1-dclick"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 145.0, 446.0, 70.0, 22.0 ],
					"text" : "r #1-reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.0, 79.0, 106.0, 22.0 ],
					"text" : "loadmess set #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 600.0, 628.0, 73.0, 22.0 ],
					"text" : "r #1-query"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 51.0, 146.0, 301.0, 22.0 ],
					"text" : "jit.window #1 @idlemouse 1 @depthbuffer 1 @fsaa 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 53.0, 512.0, 704.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"border" : 1,
					"bordercolor" : [ 0.76078431372549, 0.76078431372549, 0.847058823529412, 1.0 ],
					"id" : "obj-76",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 342.5, 177.5, 514.5, 177.5 ],
					"order" : 0,
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 342.5, 177.5, 375.5, 177.5 ],
					"order" : 1,
					"source" : [ "obj-18", 1 ]
				}
